...
var adaptiveColumnsControllerMembers = {
    ...
    _renderFormViewTemplate: function(item, cellOptions, $container) {
        ...
        var displayValue = _uiGrid_core2.default.getDisplayValue(column, value, rowData, cellOptions.rowType);
...
var AdaptiveColumnsController = _uiGrid_core.default.ViewController.inherit(adaptiveColumnsControllerMembers);
