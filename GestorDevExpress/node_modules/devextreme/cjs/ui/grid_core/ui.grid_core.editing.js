...
var EditingController = _uiGrid_core.default.ViewController.inherit(function() {
    ...
    var members = {
        ...
        optionChanged: function(args) {
            if ("editing" === args.name) {
                ...
                if (fullName === _uiGrid_core3.EDITING_EDITROWKEY_OPTION_NAME) {
                    ...
                    var isEqual = (0, _common.equalByValue)(args.value, this._changes, -1);
                    if (!isEqual) {
        ...
        _updateRowWithDelay: function(row, isCustomSetCellValue) {
            ...
            this.addDeferred(deferred);
            setTimeout((function() {
                var _this29$_editForm;
                var elementContainer = (null === (_this29$_editForm = _this29._editForm) || void 0 === _this29$_editForm ? void 0 : _this29$_editForm.element()) || _this29.component.$element().get(0);
                ...
                if (columnIndex >= 0) {
                    ...
                    _this29._delayedInputFocus($focusedItem, (function() {
                        setTimeout((function() {
                            var _this29$component$$el;
                            focusedElement = _dom_adapter.default.getActiveElement(null === (_this29$component$$el = _this29.component.$element()) || void 0 === _this29$component$$el ? void 0 : _this29$component$$el.get(0));
        ...
        shouldHighlightCell: function(parameters) {
            ...
            return cellModified && parameters.column.setCellValue && (this.getEditMode() !== _uiGrid_core3.EDIT_MODE_ROW || !parameters.row.isEditing)
        }
    };
    return members
}());
        ...
        views: {
            rowsView: {
                ...
                _renderCore: function(change) {
                    var _this34 = this;
                    this.callBase.apply(this, arguments);
                    return this._waitAsyncTemplates(change, true).done((function() {
