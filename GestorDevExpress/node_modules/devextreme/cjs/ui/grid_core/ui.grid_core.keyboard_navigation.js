...
var keyboardNavigationMembers = {
    ...
    _initViewHandlers: function() {
        ...
        rowsView.renderCompleted.add((function(e) {
            ...
            if (isFocusedViewCorrect && isFocusedElementCorrect) {
                needUpdateFocus = _this2._isNeedFocus ? !isAppend : _this2._isHiddenFocus && isFullUpdate && !(null !== e && void 0 !== e && e.virtualColumnsScrolling);
    ...
    _isInsideEditForm: function(element) {
        var $editForm = (0, _renderer.default)(element).closest("." + this.addWidgetPrefix(EDIT_FORM_CLASS));
...
var KeyboardNavigationController = _uiGrid_core.default.ViewController.inherit(keyboardNavigationMembers);
