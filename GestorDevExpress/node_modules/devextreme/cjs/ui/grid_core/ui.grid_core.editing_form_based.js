            ...
            editing: {
                ...
                _handleDataChanged: function(args) {
                    if (this.isPopupEditMode()) {
                        ...
                        var hasEditRow = null === args || void 0 === args ? void 0 : null === (_args$items = args.items) || void 0 === _args$items ? void 0 : _args$items.some((function(item) {
                            return (0, _common.equalByValue)(item.key, editRowKey)
                        }));
                        var onlyInsertChanges = (null === (_args$changeTypes = args.changeTypes) || void 0 === _args$changeTypes ? void 0 : _args$changeTypes.length) && args.changeTypes.every((function(item) {
                            return "insert" === item
                        }));
                ...
                _handleFormOptionChange: function(args) {
                    ...
                    } else if (null !== (_this$_editPopup5 = this._editPopup) && void 0 !== _this$_editPopup5 && _this$_editPopup5.option("visible") && 0 === args.fullName.indexOf(_uiGrid_core.EDITING_FORM_OPTION_NAME)) {
                        this._repaintEditPopup()
                    }
                },
