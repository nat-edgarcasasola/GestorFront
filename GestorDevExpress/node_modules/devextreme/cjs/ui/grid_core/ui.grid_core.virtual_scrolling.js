...
var VirtualScrollingRowsViewExtender = function() {
    ...
    return {
        ...
        renderDelayedTemplates: function(e) {
            var _this3 = this;
            this._waitAsyncTemplates(e).done((function() {
        ...
        _updateContent: function(tableElement, change) {
            ...
            if ("append" === changeType || "prepend" === changeType) {
                this._waitAsyncTemplates(change).done((function() {
            ...
            data: function() {
                var members = {
                    ...
                    initVirtualRows: function() {
                        ...
                        if (!this._rowsScrollController) {
                            ...
                            this._rowsScrollController.positionChanged.add((function() {
                                ...
                                null === (_this7$_dataSource = _this7._dataSource) || void 0 === _this7$_dataSource ? void 0 : _this7$_dataSource.setViewportItemIndex(_this7._rowsScrollController.getViewportItemIndex())
                            }))
                        }
                        if (false === this.option(LEGACY_SCROLLING_MODE)) {
                    ...
                    _loadItems: function(checkLoading, viewportIsFilled) {
                        var _dataSourceAdapter$lo, _dataSourceAdapter$pa, _this10 = this;
                        var virtualPaging = isVirtualPaging(this);
                    ...
                    _applyFilter: function() {
                        ...
                        null === (_this$_dataSource4 = this._dataSource) || void 0 === _this$_dataSource4 ? void 0 : _this$_dataSource4.loadPageCount(1);
                        this.callBase.apply(this, arguments)
                    }
                };
