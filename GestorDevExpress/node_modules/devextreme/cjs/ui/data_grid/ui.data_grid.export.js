...
var _uiGrid_core = require("../grid_core/ui.grid_core.export");
...
var ExportController = _uiData_grid.default.ViewController.inherit({}).inherit({
    ...
    _getColumns: function(initialColumnWidthsByColumnIndex) {
        ...
        result = (0, _uiGrid_core.prepareItems)(result.slice(0, -1), this._getEmptyCell());
        result.push(columns);
        return result
    },
                ...
                _getExportToolbarItems: function() {
                    ...
                    formats.forEach((function(formatType) {
                        ...
                        items.push({
                            ...
                            icon: exportAllIcon,
                            onClick: function() {
                                _this3._exportController[exportMethod](false, formatType)
                            }
                        });
                        if (exportOptions.allowExportSelectedData) {
                            items.push({
                                ...
                                onClick: function() {
                                    _this3._exportController[exportMethod](true, formatType)
                                }
                            })
                        }
                    }));
