...
require("./data_source");
var _index = require("./sortable/index");
    ...
    _renderFieldsTreeView: function(container) {
        ...
        var treeView = that._createComponent(container, _tree_view.default, {
            ...
            itemTemplate: function(itemData, itemIndex, itemElement) {
                var $item = (0, _renderer.default)("<div>").toggleClass("dx-area-field", !itemData.items).attr(_index.SortableConst.attrs.treeViewItem, true).data("field", itemData.field).appendTo(itemElement);
                if (itemData.icon) {
                    (0, _icon.getImageContainer)(itemData.icon).appendTo($item)
