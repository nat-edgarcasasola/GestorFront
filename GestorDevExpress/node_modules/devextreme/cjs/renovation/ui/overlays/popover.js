...
var Popover = function(_InfernoComponent) {
    ...
    _createClass(Popover, [{
        ...
        get: function() {
            ...
            return this.__getterCache.componentProps = (_this3$props$visible = _extends({}, _this3.props, {
                visible: void 0 !== _this3.props.visible ? _this3.props.visible : _this3.state.visible
            }), children = _this3$props$visible.children, restProps = _objectWithoutProperties(_this3$props$visible, _excluded), {
                children: children,
                restProps: restProps
            });
            var _this3$props$visible, children, restProps
        }
    }, {
        key: "restAttributes",
        get: function() {
            var _this$props$visible = _extends({}, this.props, {
                ...
                restProps = (_this$props$visible.accessKey, _this$props$visible.activeStateEnabled, _this$props$visible.animation, _this$props$visible.children, _this$props$visible.className, _this$props$visible.container, _this$props$visible.contentTemplate, _this$props$visible.defaultVisible, _this$props$visible.deferRendering, _this$props$visible.disabled, _this$props$visible.focusStateEnabled, _this$props$visible.height, _this$props$visible.hideEvent, _this$props$visible.hideOnOutsideClick, _this$props$visible.hint, _this$props$visible.hoverStateEnabled, _this$props$visible.maxHeight, _this$props$visible.maxWidth, _this$props$visible.minHeight, _this$props$visible.minWidth, _this$props$visible.onClick, _this$props$visible.onHidden, _this$props$visible.onHiding, _this$props$visible.onInitialized, _this$props$visible.onKeyDown, _this$props$visible.onOptionChanged, _this$props$visible.onShowing, _this$props$visible.onShown, _this$props$visible.onTitleRendered, _this$props$visible.position, _this$props$visible.rtlEnabled, _this$props$visible.shading, _this$props$visible.shadingColor, _this$props$visible.showCloseButton, _this$props$visible.showEvent, _this$props$visible.showTitle, _this$props$visible.tabIndex, _this$props$visible.target, _this$props$visible.title, _this$props$visible.titleTemplate, _this$props$visible.toolbarItems, _this$props$visible.visible, _this$props$visible.visibleChange, _this$props$visible.width, _objectWithoutProperties(_this$props$visible, _excluded2));
            return restProps
        }
    }]);
    return Popover
