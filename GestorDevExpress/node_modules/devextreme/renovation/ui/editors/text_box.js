/**
 * DevExtreme (renovation/ui/editors/text_box.js)
 * Version: 22.2.4
...
var TextBox = function(_BaseInfernoComponent) {
    ...
    _createClass(TextBox, [{
        ...
        get: function() {
            var _this$props$value = _extends({}, this.props, {
                ...
                restProps = (_this$props$value.accessKey, _this$props$value.activeStateEnabled, _this$props$value.buttons, _this$props$value.className, _this$props$value.defaultValue, _this$props$value.disabled, _this$props$value.focusStateEnabled, _this$props$value.height, _this$props$value.hint, _this$props$value.hoverStateEnabled, _this$props$value.inputAttr, _this$props$value.isValid, _this$props$value.label, _this$props$value.labelMode, _this$props$value.mask, _this$props$value.maskChar, _this$props$value.maskInvalidMessage, _this$props$value.maskRules, _this$props$value.maxLength, _this$props$value.mode, _this$props$value.name, _this$props$value.onClick, _this$props$value.onFocusIn, _this$props$value.onKeyDown, _this$props$value.readOnly, _this$props$value.rtlEnabled, _this$props$value.showClearButton, _this$props$value.showMaskMode, _this$props$value.spellCheck, _this$props$value.stylingMode, _this$props$value.tabIndex, _this$props$value.useMaskedValue, _this$props$value.validationError, _this$props$value.validationErrors, _this$props$value.validationMessageMode, _this$props$value.validationMessagePosition, _this$props$value.validationStatus, _this$props$value.value, _this$props$value.valueChange, _this$props$value.valueChangeEvent, _this$props$value.visible, _this$props$value.width, _objectWithoutProperties(_this$props$value, _excluded));
            return restProps
        }
    }]);
    return TextBox
