...
export class GanttTreeList {
    ...
    _onNodesInitialized(e) {
        var _this$_savedExpandedK;
        var expandedKeys = null === (_this$_savedExpandedK = this._savedExpandedKeys) || void 0 === _this$_savedExpandedK ? void 0 : _this$_savedExpandedK.filter(k => !!this._treeList.getNodeByKey(k));
        if (expandedKeys) {
