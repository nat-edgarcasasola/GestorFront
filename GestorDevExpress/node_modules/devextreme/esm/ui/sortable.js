...
var Sortable = Draggable.inherit({
    ...
    _getEventArgs: function(e) {
        var _this$_getSourceEleme, _this$_getSourceEleme2, _this$_getSourceEleme3;
        var sourceDraggable = this._getSourceDraggable();
        var targetDraggable = this._getTargetDraggable();
        var isTargetInDom = null !== (_this$_getSourceEleme = null === (_this$_getSourceEleme2 = this._getSourceElement()) || void 0 === _this$_getSourceEleme2 ? void 0 : null === (_this$_getSourceEleme3 = _this$_getSourceEleme2.parent()) || void 0 === _this$_getSourceEleme3 ? void 0 : _this$_getSourceEleme3.length) && void 0 !== _this$_getSourceEleme ? _this$_getSourceEleme : true;
        var dropInsideItem = targetDraggable.option("dropInsideItem");
        var skipOffsetting = dropInsideItem || !isTargetInDom;
        return extend(this.callBase.apply(this, arguments), {
